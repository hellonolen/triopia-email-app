  ...
  return (
    <div style={{ 
      ...
      <div className="flex" style={{ flex: 1, overflow: "hidden" }}>
        ...
        {/* Full-Width Content for Admin/Settings Views */}
        {['Admin', 'Notes', 'Calendar', 'Contacts', 'Settings', 'Analytics', 'Appearance', 'Profile'].includes(activeView) && (
          <div style={{ flex: 1, background: "white", overflowY: "auto" }}>
            ...
            {activeView === 'Settings' && (
              <div style={{ padding: "24px" }}>
                <p>Settings - Full Width</p>
              </div>
            )}
            {activeView === 'Notes' && (
              <div style={{ padding: "24px" }}>
                <p>Notes - Full Width</p>
              </div>
            )}
            {activeView === 'Calendar' && (
              <div style={{ padding: "24px" }}>
                <p>Calendar - Full Width</p>
              </div>
            )}
            {activeView === 'Contacts' && (
              <div style={{ padding: "24px" }}>
                <p>Contacts - Full Width</p>
              </div>
            )}
          </div>
        )}
