...
export default function Sidebar({ selectedFolder, onFolderSelect, getUnreadCount, onCompose, onEmailDrop }: SidebarProps) {
  ...
  return (
    <aside className="w-[260px] bg-card border-r border-border flex flex-col h-full p-2">
      <div className="mb-2">
        <Button
          onClick={onCompose}
        ...
        {utilities.map((item) => {
          ...
          return (
            <button
              ...
              className="w-full flex items-center gap-2 px-2 py-1.5 rounded-md hover:bg-muted transition-all duration-200"
            >
